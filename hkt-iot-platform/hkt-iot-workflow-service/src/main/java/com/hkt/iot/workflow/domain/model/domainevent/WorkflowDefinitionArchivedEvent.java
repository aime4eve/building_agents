 ...
 */
@Getter
public class WorkflowDefinitionArchivedEvent implements DomainEvent {
    ...
    private final UserId archivedBy;

    public WorkflowDefinitionArchivedEvent(
        ...
        this.archivedBy = Objects.requireNonNull(archivedBy);
    ...
    public String getEventType() {
        return "WorkflowDefinitionArchived";
    }
}
