...
-- 说明: 按应用/租户的空间分组
-- ============================================================================
CREATE TABLE IF NOT EXISTS logical_space_group (
    -- 主键
    id                    BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 说明: 逻辑空间分组成员关系表
-- ============================================================================
CREATE TABLE IF NOT EXISTS logical_space_group_member (
    -- 主键
    id                    BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 显示创建的表
SHOW TABLES;
SELECT 'Space management module tables created successfully!' AS status;
